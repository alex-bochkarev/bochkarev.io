...
*Summary* <hr>
 ...
 - though, there are good tools out there: personally, I use a system that is
   based on [[https://www.zotero.org/][Zotero]] and some black magic involving [[https://www.spacemacs.org/][(Space)Emacs]] (the latter is
   *not* really beginner-friendly)
 - there are several approaches to keep notes (and there are some good tools -- see [[#software]]);
...
* A note on notes.
  ...
  - Then, there is a story about [[https://en.wikipedia.org/wiki/Zettelkasten][Zettelkasten]]. A slip-box with notes.
    ...
    + 💬 *A community:* [[https://www.reddit.com/r/Zettelkasten/comments/b566a4/what_is_a_zettelkasten/][r/Zettelkasten]] on Reddit (the linked note includes couple of
      ...
      separately)
    + 🗎 *A paper:* the original Luhmann's paper /"Kommunikation mit Zettelkästen"/
      (however, in German 🇩🇪);
